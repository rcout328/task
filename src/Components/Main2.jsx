export default function Main2() {
  return (
    <div className="flex flex-col items-center mad:ml-80 mad:mr-80">
      ...
      <div className="flex flex-col items-center text-center uppercase text-5xl font-medium mt-20 space-y-4">
      ...
      <div className="flex flex-row items-center mx-20 my-20 space-x-10">
        <img
          src="https://i.ibb.co/wBfz1bY/valery-sysoev-LDAir-ERNzew-unsplash.jpg"
          alt="Exercise Visual"
